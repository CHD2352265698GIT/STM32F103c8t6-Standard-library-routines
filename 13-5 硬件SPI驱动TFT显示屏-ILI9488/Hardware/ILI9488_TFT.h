#ifndef __ILI9488_TFT_H
#define __ILI9488_TFT_H
#include "stm32f10x.h"   
#include "stdlib.h"
#include "gpio_rw.h"
...
void LCD_SetCursor(uint16_t statr_x,uint16_t start_y,uint16_t end_x,uint16_t end_y);										//设置光标	    															  
